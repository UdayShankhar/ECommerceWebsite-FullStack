        ...
        <div id='myportd'>
            ...
            <div className='cards'>
                <article className='blog'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color:'wheat',fontSize:'20px'}}>Full Stack Blog Application</p>
                ...
                <article className='e-commerce'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>Full Stack E-Commerce Application</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='covid'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>COVID-19 tracker application</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='contact-book'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>Contacts Book application</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
...
{/* 
            ...
            <div className='cards2'>
                ...
                <article className='apple'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>Apple website</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='tictactoe'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>Tic Tac Toe application</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                        <li>Designed and developed a Tic Tac Toe game using React JS</li>
                ...
                <article className='todo'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>to do application</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='hotel-booking'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>hotel booking application</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='weather'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>Weather application</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='swiggy'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>SWIGGY website</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='tripadvisor'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>tripadvisor website</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='bookreading'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>BOOK READING APPLICATION</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
            ...
            <div className='cards3'>
                ...
                <article className='imgslider'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>IMAGE SLIDER</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                        <li>Developed an Image-Slider application using HTML5 and JavaScript</li>
                ...
                <article className='quote'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>QUOTE GENERATOR</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                <article className='youtube'>
                    ...
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '16px', color: 'wheat', fontSize: '20px' }}>EDUCATIONAL WEBSITE DESIGN</p>
                    <ul className='post-details' style={{ display: 'flex', flexWrap: 'wrap' }}>
                        <li>Educational Website designed from stratch using HTML ,CSS3 and JavaScript</li>
                ...
                <article className='chat'>
                    <p className='project-title' style={{ textTransform: 'uppercase', marginTop: '166px', color: 'wheat', fontSize: '30px' }}>+ 30 more projects</p>
